...
public class ModelNecromancySkeleton extends ModelBiped
{
	//Shamelessly stolen from Mojang and edited
    public ModelNecromancySkeleton()
    {
        this(0.0F, false);
    }

    public ModelNecromancySkeleton(float modelSize, boolean p_i46303_2_)
    {
